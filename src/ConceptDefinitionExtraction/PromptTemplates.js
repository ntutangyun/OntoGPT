...
export const InstructionTemplate = `Describe the following concepts in the ontology context.
`;

export const FormatTemplate = `Format your response in the following way: @ concept name @ concept description @`;
