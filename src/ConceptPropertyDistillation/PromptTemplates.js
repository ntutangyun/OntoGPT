...
export const InstructionTemplate = `In the ontology context, list the properties of the following concepts:
`;

export const FormatTemplate = `Format your response in the following way: @ concept name @ concept property name @.
For example:
@ Vehicle @ Length @
@ Vehicle @ Width @
@ Rain @ Intensity @
